            ...
            @include('components.topbar')
                ...
                <div class="container-fluid" dir="rtl" style="text-align : right">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form autocomplete="off" class="form-horizontal" action="/validate_recours" method="POST"  enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input  readonly style="text-align : right" dir="ltr" required="" value="{{$patient->num_card}}" type="text" class="form-control"  name="old_num">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input   style="text-align : right" dir="ltr" required="" value="" type="number" class="form-control" id="new_num" name="new_num">
                                    </div>
                                </div>
                                <div class="form-group row">
