            ...
            @include('components.topbar')
                ...
                <div class="container-fluid" dir="rtl" style="text-align : right">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form autocomplete="off" class="form-horizontal" action="/update_real_recours" method="POST"  enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input  readonly style="text-align : right" dir="ltr" required="" value="{{$recours->old_taux}}" type="number" class="form-control"  name="old_taux">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-lg-2 text-right" for="title"> رقم البطاقة القديم </label>
                                    <div class="col-lg-8">
                                        <input  readonly style="text-align : right" dir="ltr" required="" value="{{$recours->old_num}}" type="text" class="form-control"  name="old_num">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    <label class="control-label col-lg-2 text-right" for="title"> رقم البطاقة الجديد </label>
                                    <div class="col-lg-8">
                                        <input   style="text-align : right" dir="ltr" readonly required="" value="{{$recours->new_num}}" type="number" class="form-control" id="new_num" name="new_num">
                                    </div>
                                </div>
                                <div class="form-group row">
                                ...
                                <div class="form-group" align="center">
                                    <button class="btn btn-primary" type="submit">تثبيت</button>
                                </div>
                            </from>
                        </div>
                    </div>
...
function get_last(){
    ...
    $.ajax({
        ...
        success: function(response) {
            ...
            num_card = document.getElementById('new_num');
