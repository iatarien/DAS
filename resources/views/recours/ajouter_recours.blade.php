            ...
            @include('components.topbar')
                ...
                <div class="container-fluid" dir="rtl" style="text-align : right">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form autocomplete="off" class="form-horizontal" action="/insert_recours" method="POST"  enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-lg-8">
                                        <input  style="text-align : right" dir="ltr" required="" value="{{$patient->taux}}" type="number" class="form-control"  name="new_taux">
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <label class="control-label col-lg-2 text-right" for="title">تاريخ الطعن</label>
                                    <div class="col-lg-8">
                                    <input   style="text-align : right" required="" type="date" class="form-control" value="" name="date_recours">
                                    </div>
                                </div>
