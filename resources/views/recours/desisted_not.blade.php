                ...
                <div class="container-fluid" dir="rtl" style="text-align : right">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary"> التنازلات غير المثبتة  </h6>
                        </div>
                        <div class="card-body">
                                ...
                                style="width : 100%; text-align : center; color : black; font-size : 14px;">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            @if($user->id == $patient->desisteur)
                                            <td><a class="btn btn-info" href="/ajouter_desistement/{{$patient->id_patient}}"> تعديل </a></td>
                                            @else
